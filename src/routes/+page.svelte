...
<main class="w-screen h-screen fixed">
    <div class="h-12 lg:h-16 w-screen flex flex-row items-center justify-between py-3 px-8 absolute z-40">
        <button class="h-full hidden lg:block" on:click={setToFrameSix}>
    ...
    <div class="w-screen h-screen bg-masthead-pink fixed z-50 top-0 left-0 flex flex-col items-center justify-center gap-20" transition:fly={{y:"-100%"}}>
        <button class="" on:click={()=>{ setToFrameSix(); isMobileNavActive=false;}}>
            <span class="flex flex-row items-center bump">
                <div class="w-40 btn-text text-light-pink hover:text-pink transition-colors">I WANT TO HELP</div>
                <img class="h-6" src={helpArrow} alt="down arrow" />
            </span>
...
>
  ...
  <!-- Form fields -->
  <input type="text" name="name" placeholder="Your Name" class="p-3 rounded-sm" required />
  <input type="email" name="email" placeholder="Your Email Address" class="p-3 rounded-sm" required />
  <input type="text" name="subject" placeholder="Subject" class="p-3 rounded-sm" required />
  <textarea name="message" class="w-full h-48 p-3 rounded-sm" placeholder="Your Message" required></textarea>

  <button type="submit" class="flex flex-row gap-3">
    ...
    <div class="w-2 gap-4 flex flex-col absolute right-4 md:right-12 top-1/2 -translate-y-1/2 z-40">
        ...
        <Panel frame={1}>
            <div class="w-full h-full relative {isFrameOneStarted ? 'cursor-default' : ''} transition-colors ease-linear" style="background-color:{COLOR_KEY[$bgColor]}; transition-duration:{1000*FRAME_SPEED}ms" >
                        ...
                        <svg out:fade={{easing:(t)=>t, duration:2000*FRAME_SPEED}} class="absolute bottom-12 md:bottom-16 left-[200px] sm:left-[400px] md:left-[480px] right-auto lg:left-auto lg:right-20 xl:right-52 md:scale-100 sm:scale-75 scale-[50%]  xl:scale-110 xl:-translate-x-[5%] xl:-translate-y-[5%]" width="227" height="410" fill={COLOR_KEY[$bgColor]||'white'} viewBox="0 0 227 410" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg in:fade={{delay:400*FRAME_SPEED, easing:(t)=>t, duration:2000*FRAME_SPEED}} class="absolute bottom-40 lg:bottom-48 right-auto -left-12 sm:left-8 lg:left-auto lg:right-[620px] md:scale-100 sm:scale-75 scale-[50%] xl:scale-110 xl:-translate-x-[5%] xl:-translate-y-[5%]" width="431" height="177" viewBox="0 0 431 177" fill="white" xmlns="http://www.w3.org/2000/svg">
    ...
    <Panel frame={4}>
        ...
        <div class="bg-darkest-red w-screen h-screen absolute">
            ...
            <div class="w-full h-full flex flex-col items-center justify-center z-20" out:fly={{x:"-100vw", duration:400, opacity:1}}>
                ...
                <button class="hover:brightness-125 bump bob-always" on:click={()=>isMythOne=true}>
            ...
            {#if !isMythOneBusted}
            <img src={mythOneShatterLeft} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"-100%", opacity:1, easing: crackOpenEase}}/>
            <img src={mythOneShatterRight} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"100%", opacity:1, easing: crackOpenEase}}/>
            ...
            {#if !isMythTwoBusted}
            <img src={mythTwoShatterLeft} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"-100%", y:"-100%", opacity:1, easing: crackOpenEase}}/>
            <img src={mythTwoShatterRight} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"100%", y:"100%", opacity:1, easing: crackOpenEase}}/>
            ...
            <img src={mythThreeShatterLeft} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"-100%", y:"100%", opacity:1, easing: crackOpenEase}}/>
            <img src={mythThreeShatterRight} alt="shattering background" class="z-20 absolute h-screen w-screen top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 object-cover" out:fly={{delay:200, duration:1800, x:"100%", y:"-100%", opacity:1, easing: crackOpenEase}}/>
    ...
    <Panel frame={5}>
        <div class="w-full h-full absolute top-0 left-0 overflow-hidden flex flex-col items-center justify-start pt-28 sm:pt-32 transition-colors duration-[6000ms] delay-1000 ease-out ">
           ...
           {#key frameFiveBenchOffsetLeft}
                <svg out:fade={{easing:(t)=>t, duration:2000*FRAME_SPEED}} style="left:{frameFiveBenchOffsetLeft}px" class="absolute bottom-12 md:bottom-16 md:scale-100 sm:scale-75 scale-[50%]  xl:scale-110 -translate-x-24 xl:-translate-y-[5%]" width="227" height="410" fill={COLOR_KEY['day']} viewBox="0 0 227 410" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg in:fade={{easing:(t)=>t, duration:4000*FRAME_SPEED}} style="left:{frameFiveBenchOffsetLeft}px" class="absolute bottom-12 md:bottom-16 md:scale-100 sm:scale-75 scale-[50%]  xl:scale-110 -translate-x-72 sm:-translate-x-[440px] lg:-translate-x-[200%] xl:-translate-x-[175%] translate-y-7 md:translate-y-0 xl:-translate-y-[5%]" width="285" height="510" fill={COLOR_KEY[$bgColor]||'white'} viewBox="0 0 285 510" xmlns="http://www.w3.org/2000/svg">
